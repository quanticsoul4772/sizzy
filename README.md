...
> The project is named **sizzy**. The Python package and module are still named `devharness` (the code rename is in progress), so the commands below use `devharness`.
