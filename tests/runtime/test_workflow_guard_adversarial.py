"""B4.2: workflow_guard adversarial — known-bad denies; a weakened fixture is caught."""
...
_WEAK_NAME = "b42_weak_workflow_guard"
...
def test_known_bad_denies():
    conn, bus = _setup()
    result = run_probe(PROBES["workflow_modified"], conn, bus, now_millis=lambda: 5)
...
def test_weakened_gate_caught():
    ...
    probe = KnownBadProbe(probe_name="b42_weak_workflow_modified", target_gate=_WEAK_NAME, context_factory=lambda: {'touched_paths': ['.github/workflows/ci.yml']})
